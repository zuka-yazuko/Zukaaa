...
const crtLoveTl = () => {
  ...
  return (new mojs.Timeline).add([
    new mojs.Tween({
      duration: move,
      onStart: () => {
        [el.i, el.l, el.o, el.v, el.e, el.y, el.o2, el.u].forEach(elx => {
          elx.style.opacity = 1;
          elx.style = 'transform: translate(0px, 0px) rotate(0deg) skew(0deg, 0deg) scale(1, 1); opacity: 1;';
        })
      },
      onComplete: () => {
        [el.l, el.o, el.v, el.e].forEach(elx => elx.style.opacity = 0);
        el.blop.play();
      }
    }),
    ...
    new mojs.Tween({
      ...
      onComplete: () => {
        [el.y, el.o2].forEach(elx => elx.style.opacity = 0);
        el.blop.play();
      }
    }),
    ...
    new mojs.Tween({
      ...
      onUpdate: (progress) => {
        [el.i, el.l, el.o, el.v, el.e, el.y, el.o2, el.u].forEach(elx => {
          elx.style = `transform: translate(0px, 0px) rotate(0deg) skew(0deg, 0deg) scale(1, 1); opacity: ${1 * progress};`
        })
      },
      onComplete: () => {
        [el.i, el.l, el.o, el.v, el.e, el.y, el.o2, el.u].forEach(elx => {
